...
<?php 
	...
	if ($_SERVER['REQUEST_METHOD'] == "POST" ){
		...
		if(empty($_POST['book_name'])){
			$book_error = "BookName is required";
		}
		else{
			$bn = $_POST['book_name'];
			...
			$sql = "SELECT * from books WHERE BookTitle like '%$bn%'";			
...
<div id ="frm">
	<form  id = "search_bar" method = "post" action ="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>">
        <input type="text" placeholder="BOOK_NAME" name="book_name"></input>
		<span class="error">*<?php echo $book_error;?></span>
